...
<div class="container-fluid">
    <div class="wrapper">
        <div class="row mb-5">
            <!-- Details Book -->
            <div class="col-lg-6" {{$path = ''}}>
                @if($categoryProduct[0] == 'cat-001')
                <section class="col-12 p-0 mt-0" {{$path = 'books/'}}>
                    @endif
                    <div class="container-fluid">
                        <a href="">
                            <img src="{{ asset('images/'.$path.$response->product_image) }}" class="img-fluid" width="400px;" height="550px;">
                        </a>
                    </div>
                    <nav class="selected-products">
                        <div class="list-group list-group-horizontal lh">
                            <h4 class="mt-3 mr-4">{{$response->product_name}}</h4>
                            <button class="addToCard text-center ml-5" type="submit">Add to cart</button>
                        </div>
                        <p class="m-0">
                        ...
                        ?>
                        <h6 class="mt-1">{{$response->product_description}}</h6>
                        <p> Written by Shaka King
                            United States, 2021
                            Javascript</p>
                    </nav>
                </section>
            ...
            <div class="list-group list-group-vertical-lg">
                <div class="card ml-5 mb-5">
                    <div class="card-content">
                        ...
                        ?>
                        <a class="card-img" href="details/{{$response['product_id']}}">
                        ...
                        <p class="card-title m-0" style="font-size: 13px">{{$response->product_name}}</p>
                        <p class="m-0 font-weight-bold">{{$response['product_price']}}</p>
                        <div class="card-btn-out">
                            <a class="card-btn" href="{{route('cart.addProduct', ['product_id' => $response->product_id, 'user_id' => 5])}}">Add to cart</a>
                        </div>
                    </div>
                </div>
    ...
    <section class="section product">
                ...
                <div class="card card1-size ml-2">
                    ...
                    <a class="ml-3 " href="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="80" height="50" viewBox="0 0 130 50">
                            ...
                            <rect id="Rectangle_76" data-name="Rectangle 76" width="130" height="50" rx="25" transform="translate(703 703)" fill="#ff1744"/>
                            <text id="Add_to_cart" data-name="Add to cart" transform="translate(728 734)" fill="#fff" font-size="16" font-family="Roboto-Bold, Roboto" font-weight="700"><tspan x="0" y="0">Add to cart</tspan></text>
                            </g>
                        </svg>
                    </a>
                </div>
        ...
        <div class="wrapper mb-5">
            <section id="showMore" class="my-5">
        ...
        <!-- Latest Books-->
        <div class="row">
            <div class="wrapper list-group list-group-horizontal-lg">
                <h3 class="my-5">Latest Books</h3>
                <a class="text-danger ml-2 mt-1" href="">See All</a>
            </div>
            <div class="row wrapper">
                <div class="col-3 pl-0">
                    <a href="">
                        <img src="/images/books/book_05.jpg" class="img-fluid p-2" width="300px;" height="300px;">
                    </a>
                </div>
                <div class="col-3 text-star mt-1">
                    <p class="mt-1">Colombia,France</p>
                    <h4>Avangers</h4>
                    <p class="mt-1">SYNOPSIS</p>
                    <p class="synopsis">Medellin, Colombia. Pinky is on the run after freeing himself from the grip of a religious sect.
                        He finds a place to squat, but misled by his own faith, he questions everything.
                        As he tries to put back together the pieces of his life, violent memories return to haunt him,
                        and ask for revenge.</p>
                    <a class="" href="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="80" height="50" viewBox="0 0 130 50">
                            <g id="Groupe_361" data-name="Groupe 361" transform="translate(-703 -703)">
                                <rect id="Rectangle_76" data-name="Rectangle 76" width="130" height="50" rx="25" transform="translate(703 703)" fill="#ff1744" />
                                <text id="Add_to_cart" data-name="Add to cart" transform="translate(728 734)" fill="#fff" font-size="16" font-family="Roboto-Bold, Roboto" font-weight="700">
                ...
                <div class="col-3 pl-0">
                    <a href="">
                        <img src="/images/books/book_08.jpg" class="img-fluid p-2" width="300px;" height="300px;">
                    </a>
                </div>
                <div class="col-3 text-star mt-1">
                    <p class="mt-1">Colombia,France</p>
    ...
    <section class="row wrapper">
        <h3 class="mt-5 mb-4">Recently Viewed</h3>
        <div class="row wrapper mt-3 mb-5">
            <div class="col-2 mt-3">
                <div class="card card1-size ml-2">
                    <a class="navbar-brand" href="">
                        <img src="/images/books/book_03.jpg" class="img-fluid ml-3 mt-2" width="155px;" height="155px;">

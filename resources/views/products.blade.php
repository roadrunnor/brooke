...
<div class="wrapper">
    <section>
        ...
        <div class="mt-3 mb-3">
            <a href="">
                <img src="/images/books/banner/cup_pink.png">
                <img class="align-top ml-5" src="/images/books/banner/banner_book.png">
            </a>
        </div>
    </section>
</div>
            ...
            <div class="mr-lg-3" {{$i++}}>
                ...
                <div class="card mb-3">
                    <div class="card-content">
                        <a class="card-img" href="details/{{$product['product_id']}}">

...
<head>
    ...
    <link rel="stylesheet" href="/laboratoires.css" />
    ...
    <div class="header">
        ...
        <div class="top-bar theme-bg-primary-darken">
            <div class="container-fluid">
                ...
                <!-- navbar red -->
                <nav class="mubi-logo navbar navbar-expand-lg navbar-primary">
                    <div class="wrapper">
                        <a class="" href="#"></a>
                ...
                <!-- navbar all categories pink -->
                <nav class="navbar navbar-expand-lg navbar-light bg-pink p-0">
                    <div class="wrapper navbar p-0">
                        <h1 class="categorybrand m-0">
                            <span class="pl-3">
                            ...
                            <span class="align-bottom pl-4 pr-5">all categories</span>
                        </h1>
                        <ul class="navbar-nav form-inline navbar-expand mr-auto mt-0 mt-lg-0">
                            <li>
                                <h1 class="d-lg-none">BOOKS</h1>
                            </li>
                        </ul>
                    </div>
                </nav>
            ...
            <div class="row">
                ...
                <div class="col-3">
                    ...
                    @csrf
                        <div class="jumbotron">
                            <p>
                                {{-- <img src="{{public_path('images')}}/{{product->product_image}}" alt=""> --}}
                            </p>

...
<div class="wrapper">
    <section>
        <h3 class="font-weight-bold mt-5 mb-4">Selected Products</h3>
        <nav class="selected-products">
            <ul class="selected-products-items px-0">
                <li class="s-p-items m-0">Trending Item</li>
                <li class="s-p-items m-0 active">New Arrivals</li>
                <li class="s-p-items m-0">Best Sale</li>
            </ul>
        </nav>
        <div class="container-fluid mt-3 mb-3">
            <a href="">
                <img src="/images/books/cup_pink.png">
                <img class="align-top ml-5" src="/images/books/banner_book.png">
            </a>
        </div>
    </section>
</div>
...
>>>>>>> 4ec69f72107778bb7fb59fb033b169c9bedc60a4
                </div>
            </div>
            @endforeach
        </div>
